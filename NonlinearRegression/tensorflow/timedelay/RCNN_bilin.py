...
def run_test(
    ...
    tfft      = 8,
    doPlots   = False,
    plotDir   = 'params/RCNN_bilin/Figures',
    save_data = False,
    ...
    Example:
    from RCNN_bilin import run_test
    ...
    if doLoadDownsampled:
        ...
        filename = 'params/RCNN_bilin/DARM_with_bilinear_downsampled.mat'
...
if __name__ == "__main__":
    ...
    doLoadDownsampled = False
    if os.path.exists('params/RCNN_bilin/DARM_with_bilinear_downsampled.mat'):

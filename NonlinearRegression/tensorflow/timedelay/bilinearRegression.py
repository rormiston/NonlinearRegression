...
def run_test(
    ...
    tfft      = 8,
    doPlots   = False,
    plotDir   = 'params/bilinearRegression/Figures',
    save_data = False,
    ...
    Example:
    from bilinearRegressionFunc import run_test
    ...
    if doLoadDownsampled:
        ...
        filename = 'params/bilinearRegression/DARM_with_bilinear_downsampled.mat'
...
if __name__ == "__main__":
    ...
    doLoadDownsampled = False
    if os.path.exists('params/bilinearRegression/DARM_with_bilinear_downsampled.mat'):

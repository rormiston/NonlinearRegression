...
def run_test(
    ...
    kernel_size    = 10  #10
    strides        = 10
    N_features     = training_target.shape
    nb_outputs     = 10

    model = Sequential((
        Conv1D(input_shape      = N_features,
        ...
        Conv1D(filters     = filters,
               ...
               activation  = 'relu'),
        #MaxPooling1D(),
        #Convolution1D(nb_filter=10, filter_length=filter_length, activation='elu'),
        #MaxPooling1D(),
        #Dense(59,activation='elu'),
        #Dropout(0.5),
        #Dense(29,activation='elu'),
        #Dropout(0.5),
    ...
    model.compile(loss=cost_func, optimizer=optimizer)
